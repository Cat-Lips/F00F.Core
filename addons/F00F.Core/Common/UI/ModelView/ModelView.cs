...
{
    private GridContainer Grid => field ??= GetNode<GridContainer>("%Grid");
    private SubViewport View => field ??= GetNode<SubViewport>("%View");
    private Camera3D Camera => field ??= GetNode<Camera3D>("%Camera");
