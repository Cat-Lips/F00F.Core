...
{
    public static void InitTopView(this WorldBounds self, Camera3D camera = null)
    {
    ...
    public static IBounds TopView(this WorldBounds self, float y, Camera3D camera = null)
    {
    ...
    private static Camera3D GetCameraOrNull(this WorldBounds world)
