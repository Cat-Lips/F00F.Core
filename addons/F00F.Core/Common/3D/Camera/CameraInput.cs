...
public abstract partial class CameraInput : CustomResource
{
    ...
    protected internal virtual bool MouseRotate(Camera3D self, InputEvent e) => false;
    protected internal virtual bool MouseOrbit(Camera3D self, InputEvent e, in Vector3 target) => false;
}
