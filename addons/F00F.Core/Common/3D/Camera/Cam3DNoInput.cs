...
[Tool, GlobalClass]
public partial class Cam3DNoInput : Cam3DInput
{
    ...
    protected internal sealed override bool MouseRotate(Cam3D self, InputEvent e) => false;
    protected internal sealed override bool MouseOrbit(Cam3D self, InputEvent e, in Node3D target, ref Vector3 lookAt) => false;
}
