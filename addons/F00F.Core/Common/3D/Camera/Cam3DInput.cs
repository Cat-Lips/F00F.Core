...
[Tool, GlobalClass]
public partial class Cam3DInput : CustomResource
{
    ...
    protected internal virtual bool MouseRotate(Cam3D self, InputEvent e)
        => MyInput.MouseRotate(self, e, self.Config.Sensitivity, self.Config.PitchLimit);

    protected internal virtual bool MouseOrbit(Cam3D self, InputEvent e, in Node3D target, ref Vector3 lookAt)
