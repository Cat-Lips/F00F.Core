...
public static class Cam2DExtensions
{
    public static void FitToWorld(this Camera2D source, in Rect2I worldRect, float min = 1, float max = 10)
    {
        SetZoom(worldRect);
        SetLimits(worldRect);
    ...
    public static Vector2 GetZoomSize(this Camera2D source)
    {
