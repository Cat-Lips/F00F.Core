...
public abstract partial class MyInput
{
    ...
    protected void Init(string section = null)
    {
        ...
        Init(t, section, "Default", this);
    }

    protected static void Init<T>(string section = null, string dflt = "Defaults", [CallerFilePath] string caller = null) where T : MyInput
    {
        var t = typeof(T);
    ...
    private static void Init(Type t, string section, string dflt, object instance = null)
    {
        ...
        FieldInfo[] GetDefaults()
            => [.. t.GetNestedType(dflt, BindingFlags.NonPublic).GetFields()];
