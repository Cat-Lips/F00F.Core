...
namespace F00F
{
    ...
    {
        public static IEnumerable<ControlPair> GetEditControls(out Action<GlbOptions> SetData)
        {
            var childControls = () => (GlbNode.GetEditControls(out var SetChildData), SetChildData);
        ...
        public partial class GlbNode
        {
            public static IEnumerable<ControlPair> GetEditControls(out Action<GlbNode> SetData)
            {
                return UI.Create(out SetData, CreateUI);
