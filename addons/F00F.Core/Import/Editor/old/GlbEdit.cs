...
{
    private Button AcceptBtn => field ??= GetNode<Button>("%Accept");
    private Button ApplyBtn => field ??= GetNode<Button>("%Apply");
    private Button RevertBtn => field ??= GetNode<Button>("%Revert");
    private Button AbortBtn => field ??= GetNode<Button>("%Abort");

    private Button AutoApply => field ??= GetNode<Button>("%AutoApply");
    private Button ViewSource => field ??= GetNode<Button>("%ViewSource");
