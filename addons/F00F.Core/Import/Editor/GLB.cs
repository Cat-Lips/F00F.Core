...
namespace F00F
{
    ...
    public static class GLB
    {
            ...
            void AddPart(MeshInstance3D part)
            {
                ...
                void AddShape(MeshInstance3D mesh, Node3D shape, bool multi = false)
                {
                    ...
                    else
                    {
                        ...
                        shape.GlobalTransform(offset * PartTransform() * shape.Transform);
                    ...
                    {
                        return shapeType is GlbShapeType.Wheel
                            ? xform.TrimRotation()
                            : xform;
                    }
        ...
        private static Node3D[] CreateShapes(Mesh mesh, GlbShapeType shape, int max = 0) => shape switch
        {
            ...
            GlbShapeType.RayShapeX => [mesh.CreateRayShape(Vector3.Axis.X)],
            GlbShapeType.RayShapeY => [mesh.CreateRayShape(Vector3.Axis.Y)],
            GlbShapeType.RayShapeZ => [mesh.CreateRayShape(Vector3.Axis.Z)],
