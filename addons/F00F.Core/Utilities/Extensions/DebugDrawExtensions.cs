...
public static class DebugDraw
{
    ...
    public static void _DrawCentralForce(this RigidBody3D source, in Vector3 force, Godot.Color? color = null)
        => source.DrawForce(force / source.Mass, color);

    [Conditional("DEBUG_DRAW_3D")]
    public static void _DrawForce(this RigidBody3D source, in Vector3 force, in Vector3 position, Godot.Color? color = null)
        => source.DrawForce(force / source.Mass, position, color);
