...
public static class ConfigFileExtensions
{
    ...
    public static T GetV<[MustBeVariant] T>(this ConfigFile cfg, string key, T dflt = default) => cfg.GetV("", key, dflt);
    public static T GetV<[MustBeVariant] T>(this ConfigFile cfg, string section, string key, T dflt = default) => cfg.GetV(section, key, () => dflt);
    ...
    public static T GetE<T>(this ConfigFile cfg, string key, T dflt = default) where T : struct, Enum => cfg.GetE("", key, dflt);
    public static T GetE<T>(this ConfigFile cfg, string section, string key, T dflt = default) where T : struct, Enum => cfg.GetE(section, key, () => dflt);
