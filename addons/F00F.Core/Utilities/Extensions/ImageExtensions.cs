...
{
    public static float Sample(this Image source, in Vector2 size, in Vector2 offset, float x, float y, RGBA channel = RGBA.R, float dflt = 1)
    {
    ...
    public static Color Sample(this Image source, in Vector2 size, in Vector2 offset, float x, float y, float dflt = 1)
    {
