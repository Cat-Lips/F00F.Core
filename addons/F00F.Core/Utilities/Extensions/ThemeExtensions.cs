...
public static class ThemeExtensions
{
    ...
    public static T ResetFontColor<T>(this T source) where T : Control => source.SetFontColor(null);
    public static T SetFontColor<T>(this T source, Color? color) where T : Control
        => source.SetThemeColor(FontColor, color);

    public static LineEdit OverrideUneditableFontColor(this LineEdit source, Color? color = null)
        => source.SetThemeColor(UneditableFontColor, color ?? source.GetThemeColor(FontColor));

    private static T SetThemeColor<T>(this T source, StringName theme, Color? color = null) where T : Control
    {
