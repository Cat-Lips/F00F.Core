...
public static class LinqExtensions
{
    ...
    {
        return source.TryGetValue(key, out var old) ? UpdateState() : AddState();
    ...
    public static void TrySet<TKey, TValue>(this IDictionary<TKey, TValue> source, TKey key, TValue value, Action<TKey, TValue> OnValueSet)
    {
