...
public static class NodeExtensions
{
    ...
    public static T GetSibling<T>(this Node source, NodePath path) where T : class
        => source.GetParent().GetNode<T>(path);

    public static Node GetSiblingOrNull(this Node source, NodePath path)
        => source.GetParent()?.GetNodeOrNull(path);

    public static T GetSiblingOrNull<T>(this Node source, NodePath path) where T : class
        => source.GetParent()?.GetNodeOrNull<T>(path);
