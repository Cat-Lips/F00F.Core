...
public static class NodeExtensions
{
    ...
    //public static void OwnChild(this Node source, Node child) => source.AddChild(child, own: true);
    ...
    //public static void OwnSibling(this Node source, Node child) => source.AddSibling(child, own: true);
    ...
    public static T FindParent<T>(this Node source) where T : Node
    {
