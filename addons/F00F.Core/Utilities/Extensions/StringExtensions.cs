...
{
    public static string Str(this string source, string prefix = null) => source.ToStr(prefix);
    public static string ToStr(this string source, string prefix = null)
        => source.IsNullOrEmpty() ? null : $"{prefix}{source}";
