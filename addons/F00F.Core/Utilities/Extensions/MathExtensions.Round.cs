...
public static class MathExtensions_Round
{
    ...
    public static Vector2 Rounded(this in Vector2 source, MidpointRounding type = DefaultRoundType) => Round(source, type);
    public static Vector3 Rounded(this in Vector3 source, MidpointRounding type = DefaultRoundType) => Round(source, type);
