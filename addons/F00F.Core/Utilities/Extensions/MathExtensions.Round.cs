...
public static class MathExtensions_Round
{
    ...
    public static Vector2I RoundInt(this in Vector2 source, MidpointRounding type = DefaultRoundType)
        => new(source.X.RoundInt(type), source.Y.RoundInt(type));

    public static Vector3I RoundInt(this in Vector3 source, MidpointRounding type = DefaultRoundType)
        => new(source.X.RoundInt(type), source.Y.RoundInt(type), source.Z.RoundInt(type));
}
