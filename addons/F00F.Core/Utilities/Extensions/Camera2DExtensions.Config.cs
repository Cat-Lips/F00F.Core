...
public static class Camera2DExtensions_Config
{
    public static void SetLimits(this Camera2D self, in Rect2I bb, bool smooth = true)
        => self.SetLimits(bb.Position, bb.End, smooth);

    public static void SetLimits(this Camera2D self, in Vector2I size, bool smooth = true)
        => self.SetLimits(default, size, smooth);

    public static void SetLimits(this Camera2D self, in Vector2I pos, in Vector2I end, bool smooth = true)
    {
        self.LimitTop = pos.Y;
    ...
    public static void SetLimits(this Camera2D self, Node bg, bool smooth = true)
