...
{
    public static string Str(this StringName source, string prefix = " ") => source.ToStr(prefix);
    public static string StrIf(this StringName source, string prefix = " ") => source.ToStr(prefix);
    public static string ToStr(this StringName source, string prefix = " ")
