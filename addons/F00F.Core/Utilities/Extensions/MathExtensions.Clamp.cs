...
public static class MathExtensions_Clamp
{
    ...
    //public static Vector2 Clamp(this Vector2 value, float min, float max) => value.Clamp(min, max);
    ...
    //public static Vector2I Clamp(this Vector2I value, int min, int max) => value.Clamp(min, max);
    ...
    //public static Vector3 Clamp(this Vector3 value, float min, float max) => value.Clamp(min, max);
    ...
    //public static Vector3I Clamp(this Vector3I value, int min, int max) => value.Clamp(min, max);
