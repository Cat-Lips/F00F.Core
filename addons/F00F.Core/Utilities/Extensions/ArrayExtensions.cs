...
public static class ArrayExtensions
{
    ...
    public static T PickRandom<T>(this T[] source, T dflt) => source.IfAny(Rng.PickRandom, dflt);
    public static T PickRandom<T>(this IEnumerable<T> source, T dflt) => source.IfAny(Rng.PickRandom, dflt);
