...
namespace F00F
{
    public static class ArrayExtensions
    {
        ...
        public static T GetRandom<T>(this T[] source) => source[Rng.Next() % source.Length];
        public static T GetRandom<T>(this T[] source, Func<T> dflt) => source.Empty() ? dflt() : source.GetRandom();
