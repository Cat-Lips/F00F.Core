...
public static class ArrayExtensions
{
    ...
    public static bool Empty<T>(this T[] source) => source.IsEmpty();
    public static bool Empty<T>(this IEnumerable<T> source) => source.IsEmpty();
    public static bool NullOrEmpty<T>(this T[] source) => source.IsNullOrEmpty();
    public static bool NullOrEmpty<T>(this IEnumerable<T> source) => source.IsNullOrEmpty();

    public static T[] NullIfEmpty<T>(this T[] source) => source.IsNullOrEmpty() ? null : source;
    public static IEnumerable<T> NullIfEmpty<T>(this IEnumerable<T> source) => source.IsNullOrEmpty() ? null : source;
