...
public static class ArrayExtensions
{
    ...
    public static bool NotNullOrEmpty<T>(this T[] source) => !source.NotNullOrEmpty();
    public static bool NotNullOrEmpty<T>(this IEnumerable<T> source) => !source.NotNullOrEmpty();
