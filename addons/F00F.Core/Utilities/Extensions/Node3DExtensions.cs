...
namespace F00F
{
    public static class Node3DExtensions
    {
        ...
        public static bool IsMovingForward(this Node3D source, in Vector3 direction) => source.GetRelative(direction).Z < 0;
        public static bool IsMovingBack(this Node3D source, in Vector3 direction) => source.GetRelative(direction).Z > 0;
        public static bool IsMovingLeft(this Node3D source, in Vector3 direction) => source.GetRelative(direction).X < 0;
        public static bool IsMovingRight(this Node3D source, in Vector3 direction) => source.GetRelative(direction).X > 0;
        public static bool IsMovingUp(this Node3D source, in Vector3 direction) => source.GetRelative(direction).Y < 0;
        public static bool IsMovingDown(this Node3D source, in Vector3 direction) => source.GetRelative(direction).Y > 0;
