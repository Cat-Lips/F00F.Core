...
public static class InputExtensions
{
    ...
    public static bool IsKey(this InputEventKey e, Key key) => e.PhysicalKeycode == key;
    public static bool Pressed(this InputEventKey e, Key key) => e.PhysicalKeycode == key && e.Pressed;
    public static bool Released(this InputEventKey e, Key key) => e.PhysicalKeycode == key && !e.Pressed;
    public static bool JustPressed(this InputEventKey e, Key key) => e.PhysicalKeycode == key && e.Pressed && !e.Echo;
}
