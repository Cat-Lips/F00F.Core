...
using PointCollision = (CollisionObject3D Body, Vector3 Point, Vector3 Normal);
using ShapeCollision = (CollisionObject3D Body, CollisionShape3D Shape, Vector3 Point, Vector3 Normal);
