...
public static class TransformExtensions_3D
{
    ...
    public static Transform3D AlignToSurface(this Transform3D source, in Vector3 normal, bool normalised = false)
    {
        source.Basis.Y = normal;
        source.Basis.X = source.Fwd().Cross(normal);
        return normalised ? source.Orthonormalized() : source;
    }
