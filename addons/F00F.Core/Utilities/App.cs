...
{
    public static string Name => field ??= (string)ProjectSettings.GetSettingWithOverride("application/config/name");
    public static Texture2D Icon => field ??= Utils.Load<Texture2D>((string)ProjectSettings.GetSettingWithOverride("application/config/icon"));
