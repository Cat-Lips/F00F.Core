...
public static class ConfigExtensions
{
    ...
    public static void SetEnum<T>(this Config source, string key, T value) where T : struct, Enum => source.Set(key, $"{value}");
    public static void SetEnum<T>(this Config source, string section, string key, T value) where T : struct, Enum => source.Set(section, key, $"{value}");
    ...
    public static T GetEnum<T>(this Config source, string key, T @default) where T : struct, Enum => source.TryGetEnum<T>(key, out var value) ? value : @default;
    public static T GetEnum<T>(this Config source, string section, string key, T @default) where T : struct, Enum => source.TryGetEnum<T>(section, key, out var value) ? value : @default;
    ...
    public static T Get<[MustBeVariant] T>(this Config source, Node key, T @default) => source.Get(key.Name, @default);
    public static T Get<[MustBeVariant] T>(this Config source, Node section, Node key, T @default) => source.Get(section.Name, key.Name, @default);
