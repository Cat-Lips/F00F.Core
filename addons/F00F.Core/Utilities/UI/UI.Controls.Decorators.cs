...
public static partial class UI
{
    ...
    public static Label Label(string name, string text = null, string hint = null, HorizontalAlignment alignment = HorizontalAlignment.Left, MouseFilterEnum? mouse = null) => new()
    {
        Name = $"{name}Label",
