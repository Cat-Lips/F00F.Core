...
public static partial class UI
{
    ...
    public static Button Button(string name, Action OnClick, string text = null, string hint = null, bool flat = false)
    {
        var ec = NewButton();
        ec.Pressed += OnClick;
        return ec;
    ...
    public static CheckButton Toggle(string name, bool on, Action<bool> OnToggle, string text = null, string hint = null, bool flat = false)
    {
        var ec = NewToggle();
    ...
    public static Button Button(string name, Action OnClick, char text, string hint = null) => Button(name, OnClick, $"{text}", hint).SetSquareWidth();
}
