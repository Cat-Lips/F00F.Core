...
public static class StatusExtensions
{
    ...
    public static void Push(this Status status, string msg, string tag = null, [CallerFilePath] string filePath = null, [CallerMemberName] string memberName = null)
        => IStatus.Instance.Push(status, msg, tag, filePath, memberName);
}
