...
public static partial class Editor
{
    ...
    public static bool SetReadOnly(Dictionary source, StringName property, bool @if = true)
    {
        return @if
    ...
    public static bool SetDisplayOnly(Dictionary source, StringName property, bool @if = true)
    {
        return @if
            ? SetUsage(source, property, source.Usage() | PropertyUsageFlags.NoInstanceState)
            : SetUsage(source, property, source.Usage() & ~PropertyUsageFlags.NoInstanceState);
    }
    ...
    public static FieldInfo GetBackingField<T>(T source, StringName property) where T : GodotObject
    {
