...
public static class CmdLine
{
    ...
    private static class Arg
    {
        ...
        public const string SavePid = "pid.ready";
#if DEBUG
    ...
    private static class Run
    {
        ...
        {
            var _args = args.Concat(WindowArgs()).Concat(DebugArgs()).ToArray();
            ...
            static IEnumerable<string> WindowArgs()
            {
                ...
                static IEnumerable<string> WindowArgs(in Vector2 pos)
            ...
            IEnumerable<string> DebugArgs()
                => Arg.Out.Log($"godot.instance.{idx + 1}.log");
        }
    ...
    private static class Args
    {
        ...
        {
            if (Has(key, out var _value) && _value.IsVec2(out value))
                return true;
        ...
        {
            if (Has(key, out var _value) && _value.IsVec2I(out value))
                return true;
        ...
        {
            if (Has(key, out var _value) && _value.IsVec3(out value))
                return true;
        ...
        {
            if (Has(key, out var _value) && _value.IsVec3I(out value))
                return true;
