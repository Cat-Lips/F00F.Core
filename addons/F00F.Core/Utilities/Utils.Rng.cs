...
public static class Rng
{
    ...
    public static Vector2 NextVec2() => new(NextF(), NextF());
    public static Vector2 NextVec2(float max) => new(Next(max), Next(max));
    public static Vector2 NextVec2(float min, float max) => new(Next(min, max), Next(min, max));

    public static Vector3 NextVec3() => new(NextF(), NextF(), NextF());
    public static Vector3 NextVec3(float max) => new(Next(max), Next(max), Next(max));
    public static Vector3 NextVec3(float min, float max) => new(Next(min, max), Next(min, max), Next(min, max));

    public static Vector2I NextVec2I() => new(Next(), Next());
    public static Vector2I NextVec2I(int max) => new(Next(max), Next(max));
    public static Vector2I NextVec2I(int min, int max) => new(Next(min, max), Next(min, max));

    public static Vector3I NextVec3I() => new(Next(), Next(), Next());
    public static Vector3I NextVec3I(int max) => new(Next(max), Next(max), Next(max));
    public static Vector3I NextVec3I(int min, int max) => new(Next(min, max), Next(min, max), Next(min, max));
}
