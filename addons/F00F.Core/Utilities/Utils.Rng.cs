...
public static class Rng
{
    ...
    public static Vector2 V2() => new(NextF(), NextF());
    public static Vector2 V2(float max) => new(Next(max), Next(max));
    public static Vector2 V2(float min, float max) => new(Next(min, max), Next(min, max));

    public static Vector3 V3() => new(NextF(), NextF(), NextF());
    public static Vector3 V3(float max) => new(Next(max), Next(max), Next(max));
    public static Vector3 V3(float min, float max) => new(Next(min, max), Next(min, max), Next(min, max));

    public static Vector2I V2I() => new(Next(), Next());
    public static Vector2I V2I(int max) => new(Next(max), Next(max));
    public static Vector2I V2I(int min, int max) => new(Next(min, max), Next(min, max));

    public static Vector3I V3I() => new(Next(), Next(), Next());
    public static Vector3I V3I(int max) => new(Next(max), Next(max), Next(max));
    public static Vector3I V3I(int min, int max) => new(Next(min, max), Next(min, max), Next(min, max));
}
