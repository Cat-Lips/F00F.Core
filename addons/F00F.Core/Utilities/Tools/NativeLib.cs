...
public class NativeLib : DisposableNative
{
    ...
    public static NativeLib Load(string dll, out string error, bool log = false)
    {
    ...
    protected sealed override void OnDisposeNative()
