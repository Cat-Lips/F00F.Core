...
namespace F00F
{
    ...
    public abstract partial class CustomResource : Resource
    {
        ...
        protected void EnableChangedEvent() => this.SafeConnect(Resource.SignalName.Changed, ChangedEventHandler.Run);
        protected void DisableChangedEvent() => this.SafeDisconnect(Resource.SignalName.Changed, ChangedEventHandler.Run);
