...
public partial class ValueWatcher : DataView
{
    ...
    public void Sep(string title, Button cfg = null, [CallerFilePath] string f = null, [CallerMemberName] string n = null)
