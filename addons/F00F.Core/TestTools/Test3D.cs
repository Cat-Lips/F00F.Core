...
public partial class Test3D : Game3D
{
    ...
    protected sealed override void OnReady()
    {
        ...
        void LoadCfg()
        {
            ...
            WorldType = GameConfig.LoadEnum(WorldType);
        }
    ...
    private InstancePlaceholder _Arena => field ??= (InstancePlaceholder)World.GetNode("Arena");
    private InstancePlaceholder _Terrain => field ??= (InstancePlaceholder)World.GetNode("Terrain");
        ...
        void CreateWorld()
        {
            switch (WorldType)
            {
                case TestWorldType.None:
                    ...
                    break;
                case TestWorldType.Arena:
                    Arena = _Arena.CreateInstance<TestArena>();
                    ...
                    break;
                case TestWorldType.Terrain:
                    Terrain = _Terrain.CreateInstance<TestTerrain>();
